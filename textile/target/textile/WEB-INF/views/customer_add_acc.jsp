...
<div id="content-header">
	<br>
  <h4><b>வாடிக்கையாளர் கணக்கு</b></h4>
  <div id="back-button">
  	<a href="<c:url value='/cus/cuslist' />" class="btn btn-small "><span class="glyphicon glyphicon-circle-arrow-left">&nbsp;</span>பின் செல்</a>
  </div>
</div>
<br/> 
...
<form:form method="POST" modelAttribute="customerAcc" class="form-horizontal"> 
	...
	<table width="50%" border="0" cellspacing="0" cellpadding="0" style="font-size:13px;">
		<c:choose>
			...
			<c:otherwise>
			<tr>
				<td width="10%" align="left" height="45"><strong>வாடிக்கையாளர் பெயர்</strong></td>
		...
		<tr> 
			...
			<td width="20%" align="left">					
				<c:choose>
					<c:when test="${edit}">
						<input type="submit" style="font-size:15px" value="மாற்றம் செய்"" /> or <a href="<c:url value='/cus/cuslist' />">Cancel</a>
					</c:when>
					<c:otherwise>
						<input type="submit" style="font-size:15px" value="சேமி" /> or <a href="<c:url value='/cus/cuslist' />">Cancel</a>
					</c:otherwise>
				</c:choose>
			</td>
		</tr>	

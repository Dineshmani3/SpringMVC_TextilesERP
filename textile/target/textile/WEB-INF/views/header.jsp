<div style="background:url(${pageContext.request.contextPath}/static/images/bg_inner.jpg);width: 100%;border-bottom: 1px solid #edecec;">
	<div class="wrapper">
		...
		<table cellpadding="0" cellspacing="0" width="1100px" border="0" style="font-size: 12px;padding-top:5px; margin-bottom:5px;">
		    <tr>
		        <td width="157"></td>
		        <td width="867" align="right" style="color: blue;"><strong>Welcome</strong>  ${loggedinuser}</td>

...
<table width="100%" cellpadding="0" cellspacing="0" class="table table-striped table-bordered margin-datatable" id="example" style="margin:auto">
  <thead>
            <tr>
				...
				<th width="158">Contact Number</th>
				<th width="158">Address</th>
				<th width="158">Balance</th>
		...
		<c:forEach items="${customerBean}" var="user" varStatus="c">
        	...
        	<tr>
        		...
        		<fmt:formatNumber type = "number" minFractionDigits="2" value = "${user.balance}" />
       			...
       			<td><a class="btn-sm btn-primary" href="<c:url value='/cus/cuslist-${user.cusId}' />" >Edit</a></td>
				<td><a class="btn btn-sm btn-danger" href="<c:url value='/cus/delete-customer-${user.cusId}' />" >Delete</a></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
